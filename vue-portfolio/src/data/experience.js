...
export const experience = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Integrated Notion-based incident triage for our production sites, giving the team one place to report, prioritise and track production issues through to resolution.',
    ...
    stack: ['Next.js', 'React', 'Cloudflare Workers', 'GitHub Actions', 'Notion', 'Claude Code'],
    links: [
  ...
  },
  {
    ...
    summary:
      'Built and supported mission-critical services in a payment processor handling card traffic for global networks, in C++ on the processor and C# .NET on its automation suite.',
    highlights: [
      ...
      'Worked on the processor’s C# .NET automation suite, automating regression checks of transaction flows.',
    ...
    stack: ['C++', 'C#', '.NET', 'ISO 8583', 'Oracle SQL', 'Splunk', 'Test automation', 'Linux'],
    links: [],
    projects: [],
