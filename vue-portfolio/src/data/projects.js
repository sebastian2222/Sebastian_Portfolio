 ...
 *   builtHeading? (overrides the "What I built" section title),
    ...
    figures: [
      {
        ...
        caption:
          'The architecture diagram from the project report: S3-triggered tagging and thumbnail Lambdas, DynamoDB metadata, and one Lambda per query.',
      },
    ],
